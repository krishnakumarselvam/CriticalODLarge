...
AKIVehGetVehTypePosition = _AAPI.AKIVehGetVehTypePosition
...
AKIDetGetPropertiesDetectorANG = _AAPI.AKIDetGetPropertiesDetectorANG
AKIDetGetPropertiesDetectorANGById = _AAPI.AKIDetGetPropertiesDetectorANGById
...
class StructAkiEstadStream(_object):
    ...
    __swig_setmethods__["Density"] = _AAPI.StructAkiEstadStream_Density_set
    __swig_getmethods__["Density"] = _AAPI.StructAkiEstadStream_Density_get
    if _newclass:Density = _swig_property(_AAPI.StructAkiEstadStream_Density_get, _AAPI.StructAkiEstadStream_Density_set)
    ...
    __swig_setmethods__["LongQueueAvg"] = _AAPI.StructAkiEstadStream_LongQueueAvg_set
    __swig_getmethods__["LongQueueAvg"] = _AAPI.StructAkiEstadStream_LongQueueAvg_get
    if _newclass:LongQueueAvg = _swig_property(_AAPI.StructAkiEstadStream_LongQueueAvg_get, _AAPI.StructAkiEstadStream_LongQueueAvg_set)
    __swig_setmethods__["LongQueueMax"] = _AAPI.StructAkiEstadStream_LongQueueMax_set
    __swig_getmethods__["LongQueueMax"] = _AAPI.StructAkiEstadStream_LongQueueMax_get
    if _newclass:LongQueueMax = _swig_property(_AAPI.StructAkiEstadStream_LongQueueMax_get, _AAPI.StructAkiEstadStream_LongQueueMax_set)
...
ANGConnGetObjectIdA = _AAPI.ANGConnGetObjectIdA
...
ANGConnSetAttributeValueString = _AAPI.ANGConnSetAttributeValueString
